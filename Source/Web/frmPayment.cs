...
namespace TailwindPOS
{
      ...
      : Mobilize.Web.Form
   {
      ...
      private void cbFinishPayment_Click(Object eventSender, EventArgs eventArgs)
      {
      	...
      	{
            Mobilize.Web.MessageBox.Show("Payment is not complete. Press Cancel to Abort", System.Diagnostics.FileVersionInfo.GetVersionInfo(System.Reflection.Assembly.GetExecutingAssembly().Location).ProductName);
         }
      }
